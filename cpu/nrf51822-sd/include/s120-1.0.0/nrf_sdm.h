 ...
 *
 * To get interrupts forwarded to itself, the bootloader must first call MBR with command SD_MBR_COMMAND_INIT_SD,
 * and then call this function with it's own start address as parameter.
 * 
 * To get interrupts forwarded to the application the bootloader must first call MBR with command SD_MBR_COMMAND_INIT_SD,
